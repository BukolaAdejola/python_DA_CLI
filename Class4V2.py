...
English = 50
Maths = 50
English = input('Enter your Englih score: ')
Maths = input('Enter your Maths score:  ')
print
if English >= 50  and Maths >= 50:
    print('U.I considers you for admission')

else:
    print('U.I does not consider you for admission')

if English >=50 or Maths >= 50:
    print('O.O.U gives you admission')

else:
    print('O.O.U does not give you admission')